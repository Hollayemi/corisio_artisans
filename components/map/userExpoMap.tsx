...
const LocationMap = ({ setMapData, updating = false }: setLocationProp) => {
        ...
        <View className="flex-1 bg-white">
            ...
            <View className="flex-1  invisible justify-center items-center  my-4 rounded-lg">
                ...
                <Text className="text-gray-600 text-center px-4">
                    In the actual app, you would see a map where you
                    can drag a pin to your exact location
                </Text>
            ...
            <View className="bg-white py-4">
                ...
                <View className="px-6 pb-8">
                    ...
                    <Text className="text-xs text-gray-500 text-center mt-3">
                        💡 With the right location, we will get you the stores nearby
                    </Text>
                </View>
            </View>
        </View>
