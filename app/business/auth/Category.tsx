        ...
        <SafeAreaView className="bg-white flex-1 dark:bg-gray-900">
            ...
            <View className="flex-1 h-full">
                <CategorySelector
                    ...
                    refetch={refetch}
                    // handleNext={() => router.push({ pathname: "/auth/Signup1", params: { categories: JSON.stringify(selectedCategories) } })}
                    handleNext={() => router.push({ pathname: "/auth/PhoneEntry", params: { categories: JSON.stringify(selectedCategories) } })}
                    isLoading={isLoading}
