...
export default function ProductAnsSalesChart({
    defaultParams,
}: {
...
function CategoryGrowthChart({
    ...
    return (
        <View>
            <View className="bg-white rounded-2xl border p-2 py-4 border-gray-200 mb-5">
                ...
                <View className="flex-row">
                    ...
                    {/* Category Legend */}
                    <View className="space-y-4 w-32 -ml-5">
