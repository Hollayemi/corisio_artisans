...
import { useChatData } from "@/hooks/useData";
import { useGetChatMessagesQuery, useGetUsersToChatQuery } from "@/redux/business/slices/chatSlice";
import AsyncStorage from "@react-native-async-storage/async-storage";
import { useIsFocused } from "@react-navigation/native";
import { useFocusEffect, useLocalSearchParams } from "expo-router";
import { Send } from "lucide-react-native";
import React, { useCallback, useEffect, useRef, useState } from "react";
import { KeyboardAvoidingView, Platform, RefreshControl, ScrollView, StatusBar, TextInput, useColorScheme, View } from "react-native";
...
export default function UserChat() {
    ...
    const { refetch: refetchStoreToChat } = useGetUsersToChatQuery({})
    ...
    const { data: storeChat, isLoading: loadingChat, refetch: refetchMessages } = useGetChatMessagesQuery({ chatId, branchId });
